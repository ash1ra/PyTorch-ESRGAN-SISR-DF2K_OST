...
INITIALIZE_WITH_PSNR_CHECKPOINT = False
...
INFERENCE_INPUT_IMG_PATH = Path("images/inference_img_5.jpg")
INFERENCE_OUTPUT_IMG_PATH = Path("images/sr_img_5.png")
INFERECE_COMPARISON_IMG_PATH = Path("images/comparison_img_5.png")
